...
public class ElasticJobConfig {
    ...
    public SpringJobScheduler initSimpleElasticJob() {
        ...
        SpringJobScheduler springJobScheduler = new SpringJobScheduler(repaymentJob, registryCenter,
                createJobConfiguration(repaymentJob.getClass(), cron, shardingCount));
