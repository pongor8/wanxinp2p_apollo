...
public class AccountController implements AccountApi {
    ...
    public RestResponse getSMSCode(@PathVariable String mobile) {
        return accountService.getMSMCode(mobile);
    }
    ...
    public RestResponse<AccountDTO> register(@RequestBody AccountRegisterDTO accountRegisterDTO) {
        RestResponse<AccountDTO> accountDTORestResponse = RestResponse.success(accountService.register(accountRegisterDTO));
        int a = 100;
        return accountDTORestResponse;
    }
